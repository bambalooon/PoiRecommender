...
public class PoiTypeToConstraintMap {
    ...
    private static final Map<PoiType, CompositeConstraint> MAP = ImmutableMap.<PoiType, CompositeConstraint>builder()
            ...
            .put(DRIVETHROUGH_EATING,
                    new CompositeConstraintBuilder(new KeyValueEqualConstraint("takeaway", "yes")).build())
            .put(INDOOR_SPORTS,
            ...
            .put(MONUMENTS,
                new CompositeConstraintBuilder(new KeyValueEqualConstraint("amenity", "crypt")
            ...
            .put(SHOPPING_CENTER,
                new CompositeConstraintBuilder(new KeyValueEqualConstraint("amenity", "market_place")
